...
bool SceneGame::Initailze(){
	...
	m_pointlightPos = D3DXVECTOR3(0, 3.0, 0);
	m_pointlight->CreatePointLight(D3DXCOLOR(1.0, 1.0, 1.0, 1.0), 100.0f, &m_pointlightPos.x, &m_pointlightPos.y, &m_pointlightPos.z);
	...
	Object.push_back(new MeshObject("./models/tiger.x"));
